...
public class VideoStepConfig {
    ...
    public Step videoDailyProfitStep(JobRepository jobRepository, PlatformTransactionManager transactionManager,
        ...
        return new StepBuilder("videoDailyProfitStep", jobRepository)
                .<VideoDto, VideoDto>chunk(100, transactionManager) // test if the result changes by chunk size. TransactionManager: Spring’s PlatformTransactionManager that begins and commits transactions during processing.
